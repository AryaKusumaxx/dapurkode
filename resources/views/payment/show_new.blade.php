                        ...
                        <div class="relative z-10">
                            <div class="flex items-center mb-6">
                                ...
                                <div>
                                    ...
                                    <p class="text-gray-500 dark:text-gray-400">{{ $invoice->order->created_at->format('d M Y, H:i') }}</p>
                                </div>
                            </div>
                                                ...
                                                <div class="flex items-center">
                                                    <div class="flex-shrink-0 h-12 w-12">
                                                        @if($item->product && $item->product->image)
                                                            <img class="h-12 w-12 object-cover rounded-md" src="{{ asset($item->product->image) }}" alt="{{ $item->product->name }}">
                                                        @else
                                            ...
                                            <td class="px-6 py-5 whitespace-nowrap">
                                                @if($item->warranty)
                                                    <span class="px-3 py-1 inline-flex text-xs leading-5 font-semibold rounded-full bg-green-100 dark:bg-green-900 text-green-800 dark:text-green-200">
                                                        {{ $item->warranty->name }} ({{ $item->warranty->duration }} Bulan)
                                                    </span>
                                                @else
                                                    <span class="text-gray-500 dark:text-gray-400">-</span>
                                                @endif
